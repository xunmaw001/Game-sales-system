<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.youxifengmian" label="游戏封面" prop="youxifengmian">
          <file-upload
          tip="点击上传游戏封面"
          action="file/upload"
          :limit="3"
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="游戏标签" prop="youxibiaoqian">
          <el-input v-model="ruleForm.youxibiaoqian" 
              placeholder="游戏标签" clearable  :readonly="ro.youxibiaoqian"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="游戏视频" prop="youxishipin">
          <file-upload
          tip="点击上传游戏视频"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.youxishipin" label="游戏视频" prop="youxishipin">
            <el-button type="text" size="small" @click="download(ruleForm.youxishipin)">预览</el-button>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="游戏厂商" prop="youxichangshang">
          <el-input v-model="ruleForm.youxichangshang" 
              placeholder="游戏厂商" clearable  :readonly="ro.youxichangshang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="游戏厂商" prop="youxichangshang">
              <el-input v-model="ruleForm.youxichangshang" 
                placeholder="游戏厂商" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="游戏详情" prop="youxixiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.youxixiangqing" label="游戏详情" prop="youxixiangqing">
                    <span v-html="ruleForm.youxixiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.youxixiangqing = this.ruleForm.youxixiangqing.replace(reg,'../../../ssm933ag/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
